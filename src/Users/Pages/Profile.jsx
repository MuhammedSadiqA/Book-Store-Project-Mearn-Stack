...
function Profile() {
  ...
  return (
    ...
    <div style={{width:"250px",height:"250px",borderRadius:"50%",marginLeft:"70px",marginTop:"-130px"}} className='bg-white p-3' >
      <img style={{width:"230px",height:"230px",borderRadius:"50%",}} src={dp ? dp.startsWith("https://lh3.googleusercontent.com/")?dp:`${serverURL}/uploads/${dp}` : "https://gimgs2.nohat.cc/thumb/f/640/youtube-video-photography-user-profile-avatar-youtube--5006114642984960.jpg"} alt="profile image" />
    </div>
    {/* namw with edit */}
